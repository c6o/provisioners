...
export const createInquireMixin = (base: baseProvisionerType) => class extends base {
    ...
    async createInquire(args) {
        ...
        const answers = {
            githubClientId: args['git-id'] || args.answers['git-id'] || this.spec.githubClientId,
            githubClientSecret: args['git-secret'] || args.answers['git-secret'] || this.spec.githubClientSecret,
            alwaysAuth: args['always-auth'] || args.answers['always-auth'] || this.spec.alwaysAuth,
            githubServer: args['git-server'] || args.answers['git-server'] || this.spec.githubServer,
            gitlabClientId: args['gitlab-id'] || args.answers['gitlab-id'] || this.spec.gitlabClientId,
            gitlabUrl: args['gitlab-url']  || args.answers['gitlab-url']|| this.spec.gitlabUrl,
            gitlabClientSecret: args['gitlab-secret']  || args.answers['gitlab-secret']|| this.spec.gitlabClientSecret,
            gogsServer: args['gogs-server']  || args.answers['gogs-server']|| this.spec.gogsServer,
            giteaClientSecret: args['gitea-secret']  || args.answers['gitea-secret']|| this.spec.giteaClientSecret,
            giteaUrl: args['gitea-server'] || args.answers['gitea-server'] || this.spec.giteaUrl,
            bitbucketClientId: args['bitbucket-id'] || args.answers['bitbucket-id'] || this.spec.bitbucketClientId,
            bitbucketClientSecret: args['bitbucket-secret']  || args.answers['bitbucket-secret']|| this.spec.bitbucketClientSecret,
            gitUsername: args['git-username'] || args.answers['git-username'] || this.spec.gitUsername,
            gitPassword: args['git-password'] || args.answers['git-password'] || this.spec.gitPassword,
            stashConsumerKey: args['stash-consumer'] || args.answers['stash-consumer'] || this.spec.stashConsumerKey,
            stashPrivateKey: args['stash-private'] || args.answers['stash-private'] || this.spec.stashPrivateKey,
            stashServer: args['stash-server'] || args.answers['stash-server'] || this.spec.stashServer,
        }
